          ...
          >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <Box>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.7 }}>
                  For press inquiries, high-resolution media resources, or scheduling interviews with our lead curators, please contact us at <strong>press@pureframe.com</strong>.
                </Typography>
              </Box>
            </Box>
          </Paper>
