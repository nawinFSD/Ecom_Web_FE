    ...
    <Box sx={{ width: '100%' }}>
      ...
      <Grid container spacing={3}>
        {productsData.map((prod) => (
          <Grid item xs={12} sm={6} md={4} key={prod.id} id="drawings-section">
            <Box sx={{ border: '1px solid #F0F0F0', p: 1.5, position: 'relative', height: '100%', display: 'flex', flexDirection: 'column' }}>
              ...
              <Box sx={{ width: '100%', height: 260, overflow: 'hidden', backgroundColor: '#F5F5F5', mb: 2, position: 'relative' }}>
